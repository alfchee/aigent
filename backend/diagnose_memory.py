#!/usr/bin/env python3
"""
Script de diagnóstico para verificar el funcionamiento de la memoria persistente.
"""
import os
import sys
import time
...
def test_memory_persistence():
    ...
    try:
        ...
        if test_fact in memories_after:
            print("✅ ÉXITO: El hecho fue encontrado en la búsqueda")
            ...
            found_in_all = any(test_fact in str(fact) for fact in all_facts)
            if found_in_all:
            ...
            print("❌ ERROR: El hecho NO fue encontrado en la búsqueda")
