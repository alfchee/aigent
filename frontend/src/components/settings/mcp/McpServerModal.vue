    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
      ...
      <div class="p-6 space-y-6">
        ...
        <div v-if="isCustomDefinition" class="space-y-4">
            ...
            <div class="space-y-1">
                <label class="block text-sm font-medium text-slate-700">Variables de entorno requeridas</label>
                <input
...
watch(() => activeDef.value?.env_vars, (envVars) => {
    if (!envVars) return
...
async function testConnection() {
    ...
    const res = await store.testConnection(payload.server_id, payload.params, payload.env_vars, payload.definition)
    testing.value = false
