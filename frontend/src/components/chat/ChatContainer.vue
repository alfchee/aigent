...
<template>
  <div class="h-full flex flex-row overflow-hidden bg-slate-50">
          ...
          <div class="flex items-center justify-between px-2 pb-1">
            ...
            <div class="flex items-center gap-2">
              ...
              <button
                ...
                :class="{ 'text-sky-600 bg-sky-50': showLogs }"
    ...
    <div
      v-if="showLogs"
      class="w-80 border-l border-slate-200 bg-slate-900 shrink-0 h-full overflow-hidden transition-all duration-300"
    >
      <ConsoleLog />
    </div>
  </div>
