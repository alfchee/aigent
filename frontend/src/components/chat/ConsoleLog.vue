...
<template>
  <div
    class="h-full flex flex-col bg-slate-900 text-slate-300 font-mono text-xs overflow-hidden rounded-xl border border-slate-800 shadow-inner"
  >
    <!-- Header -->
      ...
      >
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2">
              ...
              <span class="text-[10px] text-slate-600 ml-auto whitespace-nowrap">{{
        ...
        <div v-if="log.expanded && log.details" class="pl-7 pr-2 pb-2">
          <div class="bg-black/30 rounded p-2 overflow-x-auto border border-white/5">
            <pre class="text-[10px] text-slate-400 whitespace-pre-wrap">{{
